...
class BusinessRulesTest extends TestCase
{
    ...
    public function test_when_multiple_discounts_colide_biggest_discount_was_applied()
    {
    ...
    public function test_currency_is_always_Eur()
    {
    ...
    public function test_when_a_product_does_not_have_a_discount_price_final_and_price_original_are_the_same()
    {
    ...
    public function test_when_a_product_does_not_have_a_discount_price_let_discount_percentage_be_null()
    {
         $product=Product::where('discount',null)->whereHas('category',function($query){
            $query->where('categories.discount',null);
        })->first();
    ...
    public function test_when_a_product_has_a_discount_price_final_is_price_original_with_discount_applied()
    {
    ...
    public function test_discount_percentage_represents_applied_discount_with_percentage_sign()
    {
        $product=Product::where('discount','>',0)->orWhereHas('category',function($query){
            $query->where('categories.discount','>',0);
        })->first();
